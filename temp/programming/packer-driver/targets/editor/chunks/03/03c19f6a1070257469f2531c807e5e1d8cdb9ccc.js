System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, instantiate, Vec3, tween, ECardDir, PLAY_AREA_COUNT, UIPoker, moveWorld2Space, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, UIGameView;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      moveWorld2Space = _unresolved_5.moveWorld2Space;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("UIGameView", UIGameView = (_dec = ccclass('UIGameView'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([Node]), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class UIGameView extends Component {
        ...
        async initPlayGroup(groupIndex, cardIndex, poker) {
          ...
          let node = poker.UIPoker.node; // let wolrdPos = node.getComponent(UITransform).convertToWorldSpaceAR(new Vec3(0, 0, 0))
...
//# sourceMappingURL=03c19f6a1070257469f2531c807e5e1d8cdb9ccc.js.map