  ...
  return {
    ...
    execute: function () {
      ...
      _export("moveWorld2Space", moveWorld2Space = (node, targetNode, cleanUp = false) => {
        let wolrdPos = node.getComponent(UITransform).convertToWorldSpaceAR(new Vec3(0, 0, 0)); // console.log('wolrdPos', wolrdPos)
...
//# sourceMappingURL=a7a2fb5b9c1ffd1f94bc96da132dc2a9b9fe494f.js.map