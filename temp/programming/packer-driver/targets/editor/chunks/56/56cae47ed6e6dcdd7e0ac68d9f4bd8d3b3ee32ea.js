    ...
    execute: function () {
      ...
      _export("UIGameView", UIGameView = (_dec = ccclass('UIGameView'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([Node]), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class UIGameView extends Component {
        ...
        async initPlayGroup(groupIndex, cardIndex, poker, i) {
          ...
          let closePokers = (_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
            error: Error()
          }), GameDB) : GameDB).getInstance().closeGroup.pokers;

          for (let index = 0; index < closePokers.length; index++) {
            const poker = closePokers[index];
            let uiPoker = this.createUIPoker(poker);
...
//# sourceMappingURL=56cae47ed6e6dcdd7e0ac68d9f4bd8d3b3ee32ea.js.map