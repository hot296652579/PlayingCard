      ...
      _export("default", GameEngine = class GameEngine {
        ...
        init(m_GameView) {
          (_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
            error: Error()
          }), GameDB) : GameDB).getInstance().createAllCard();
          this.gameView = m_GameView;
        }

        gameStart() {
          let pokers = (_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
            error: Error()
...
//# sourceMappingURL=ae769769582fd2668bd2329fe6589aa7f026b035.js.map