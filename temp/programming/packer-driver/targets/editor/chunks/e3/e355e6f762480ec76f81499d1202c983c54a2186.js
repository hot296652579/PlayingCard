System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, EventMgr, ECardDir, EnumSuit, EventGame_Enum, Poker, PokerGrop, ReceiveGroup, GameDB, _crd, RECEIVE_AREA_COUNT, PLAY_AREA_COUNT;
  ...
  return {
    ...
    execute: function () {
      ...
      ReceiveGroup = class ReceiveGroup extends PokerGrop {
        ...
        isNextPoker(poker) {
          console.log('EnumSuit[this.suit]:', (_crd && EnumSuit === void 0 ? (_reportPossibleCrUseOfEnumSuit({
            error: Error()
          }), EnumSuit) : EnumSuit)[this.suit]);
          console.log('poker.suit:', poker.suit);

          if ((_crd && EnumSuit === void 0 ? (_reportPossibleCrUseOfEnumSuit({
            error: Error()
          }), EnumSuit) : EnumSuit)[this.suit] === poker.suit) {
            if (this.groupTop) {
...
//# sourceMappingURL=e355e6f762480ec76f81499d1202c983c54a2186.js.map