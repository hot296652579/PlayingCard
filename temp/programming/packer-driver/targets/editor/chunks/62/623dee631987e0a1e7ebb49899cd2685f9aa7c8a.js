      ...
      _export("UIGameView", UIGameView = (_dec = ccclass('UIGameView'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([Node]), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class UIGameView extends Component {
        ...
        clickCardHandler(poker) {
          ...
          if ((_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
            error: Error()
          }), GameDB) : GameDB).getInstance().onCheckInPlayArea(poker) && (_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
            error: Error()
          }), GameDB) : GameDB).getInstance().onCheckIndexTop(poker)) {
            console.log('在玩牌区 且在最上方');
...
//# sourceMappingURL=623dee631987e0a1e7ebb49899cd2685f9aa7c8a.js.map