  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", GameDB = class GameDB {
        ...
        createPlayInitDB() {
          console.log('111close剩下的牌数据', this._closeGroup.pokers);
          ...
          console.log('222close剩下的牌数据', this._closeGroup.pokers);
        }
        /**改变玩牌区到收牌区数据*/
...
//# sourceMappingURL=654efd0608e285df45af9a2dee238a96c34b70b5.js.map