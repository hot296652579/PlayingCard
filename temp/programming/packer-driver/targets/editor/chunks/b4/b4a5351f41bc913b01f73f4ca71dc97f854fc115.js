System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, instantiate, Vec3, UITransform, tween, EventMgr, ECardDir, EventGame_Enum, GameDB, PLAY_AREA_COUNT, UIPoker, moveWorld2Space, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, UIGameView;
    ...
    execute: function () {
      ...
      _export("UIGameView", UIGameView = (_dec = ccclass('UIGameView'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([Node]), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class UIGameView extends Component {
        ...
        async initPlayGroup(groupIndex, cardIndex, poker, i) {
          ...
          console.log('node.getComponent(UITransform).convertToWorldSpaceAR(new Vec3(0, 0, 0))', node.getComponent(UITransform).convertToWorldSpaceAR(new Vec3(0, 0, 0)));
...
//# sourceMappingURL=b4a5351f41bc913b01f73f4ca71dc97f854fc115.js.map