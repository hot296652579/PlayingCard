System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, instantiate, Vec3, UITransform, tween, ECardDir, PLAY_AREA_COUNT, UIPoker, TweenUtil, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, UIGameView;
  ...
  function _reportPossibleCrUseOfTweenUtil(extras) {
    _reporterNs.report("TweenUtil", "../Utils/Utils", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      TweenUtil = _unresolved_5.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("UIGameView", UIGameView = (_dec = ccclass('UIGameView'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([Node]), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class UIGameView extends Component {
        ...
        initPlayGroup(groupIndex, cardIndex, poker) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var nodePos = _this.playGruopRoot.getComponent(UITransform).convertToNodeSpaceAR(wolrdPos);

            node.removeFromParent();
            node.position = nodePos;

            _this.playGruopRoot.addChild(node);
            ...
            if (poker.dir == (_crd && ECardDir === void 0 ? (_reportPossibleCrUseOfECardDir({
              ...
              yield (_crd && TweenUtil === void 0 ? (_reportPossibleCrUseOfTweenUtil({
                error: Error()
              }), TweenUtil) : TweenUtil).flip(node, 0.7, () => {
                console.log('完成翻转');
              });
            } else {
...
//# sourceMappingURL=57cb6dd19d051a4483dcb52b9a907b6018aeb4c1.js.map