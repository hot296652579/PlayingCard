      ...
      _export("default", GameDB = class GameDB {
        ...
        initEvent() {
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_OPEN_TO_UPDATE_DB, this.onOpenToReceiveOrPlay, this); // EventMgr.getInstance().on(EventGame_Enum.EVENT_OPEN_TO_UPDATE_DB, this.onOpenToPlay, this)
        }
        ...
        onOpenToReceiveOrPlay(poker) {
          ...
          for (var _index2 = 0; _index2 < RECEIVE_AREA_COUNT; _index2++) {
            var _group = this._openGroup[_index2];
...
//# sourceMappingURL=8c081c8d340c3d436dff2c0a988747ae61f891f1.js.map