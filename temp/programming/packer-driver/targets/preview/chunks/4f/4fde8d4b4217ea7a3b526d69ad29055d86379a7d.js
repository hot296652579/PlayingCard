      ...
      _export("default", GameDB = class GameDB {
        ...
        shuffle(pokers, shuffleTime) {
          ...
          for (var index = 0; index < shuffleTime; index++) {
            var snd = Math.floor(Math.random() * pokers.length - 1);
            var rnd = Math.floor(Math.random() * pokers.length - 1);
            var temp = pokers[snd];
...
//# sourceMappingURL=4fde8d4b4217ea7a3b526d69ad29055d86379a7d.js.map