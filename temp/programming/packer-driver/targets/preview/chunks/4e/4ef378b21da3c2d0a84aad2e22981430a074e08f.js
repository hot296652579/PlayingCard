        ...
        onPlayToPlay(poker) {
          for (var index = 0; index < PLAY_AREA_COUNT; index++) {
            ...
            if (group.isNextPoker(poker)) {
              ...
              console.log('连接操作 pokers', pokers);
              (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
                error: Error()
              }), EventMgr) : EventMgr).getInstance().emit((_crd && EventGame_Enum === void 0 ? (_reportPossibleCrUseOfEventGame_Enum({
                error: Error()
              }), EventGame_Enum) : EventGame_Enum).EVENT_PLAYAREA_TO_OTHERPLAY_UPDATE_VIEW, pokers, poker.indexInGroup);
            }
          }
        }
...
//# sourceMappingURL=4ef378b21da3c2d0a84aad2e22981430a074e08f.js.map