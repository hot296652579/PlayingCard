      ...
      _export("default", GameDB = class GameDB {
        ...
        shuffle(shuffleTime) {
          ...
          for (var index = 0; index < shuffleTime; index++) {
            var rnd = Math.floor(Math.random() * (index + 1));
            var poker = this._pokers[rnd];
            arr[index] = poker;
            arr[rnd] = this._pokers[index];
          }

          console.log('洗牌后的_pokers', arr);
        }
...
//# sourceMappingURL=e2c3a670f00284cf8e5493e488be5f98ea87b617.js.map