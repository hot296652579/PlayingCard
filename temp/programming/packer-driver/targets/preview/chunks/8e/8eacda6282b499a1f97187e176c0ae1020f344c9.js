      ...
      _export("default", GameDB = class GameDB {
        ...
        shuffle(pokers, shuffleTime) {
          ...
          for (var index = 0; index < shuffleTime; index++) {
            var snd = Math.floor(Math.random() * pokers.length + 10);
            var rnd = Math.floor(Math.random() * pokers.length + 10);
            var temp = pokers[snd];
...
//# sourceMappingURL=8eacda6282b499a1f97187e176c0ae1020f344c9.js.map