      ...
      _export("default", GameEngine = class GameEngine {
        ...
        initEvent() {
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_GAME_START, this.gameView.playGame, this.gameView);
        }

        gameStart() {
          (_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
            error: Error()
          }), GameDB) : GameDB).getInstance().startGame(); // this.gameView.playGame()
        }
...
//# sourceMappingURL=4b7901d2ee8912e046b577613b57ea087959072f.js.map