System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, instantiate, Vec3, tween, EventMgr, ECardDir, EventGame_Enum, GameDB, PLAY_AREA_COUNT, UIPoker, moveWorld2Space, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, UIGameView;
      ...
      _export("UIGameView", UIGameView = (_dec = ccclass('UIGameView'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([Node]), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class UIGameView extends Component {
        ...
        initPlayGroup(groupIndex, cardIndex, poker, i) {
          ...
          return _asyncToGenerator(function* () {
            ...
            } //为了close数据与ui显示层对应 打补丁


            _this.closeSendArea.removeAllChildren();

            var closePokers = (_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
              error: Error()
            }), GameDB) : GameDB).getInstance().closeGroup.pokers;

            for (var _index2 = 0; _index2 < closePokers.length; _index2++) {
              var _poker = closePokers[_index2];

              var uiPoker = _this.createUIPoker(_poker);

              _this.closeSendArea.addChild(uiPoker.node);

              uiPoker.node.setPosition(0.5 * _index2, 0.2 * _index2, 0);
              _index2++;
            }

            if (_this.closeSendArea.children.length <= 24) {
              for (var _index3 = 0; _index3 < _this.closeSendArea.children.length; _index3++) {
                var children = _this.closeSendArea.children[_index3];
                console.log(children.getComponent(_crd && UIPoker === void 0 ? (_reportPossibleCrUseOfUIPoker({
                  error: Error()
                }), UIPoker) : UIPoker).poker.count + ',' + children.getComponent(_crd && UIPoker === void 0 ? (_reportPossibleCrUseOfUIPoker({
                  error: Error()
                }), UIPoker) : UIPoker).poker.suit);
              }
            }
          })();
        }
...
//# sourceMappingURL=71b78816acb87d6b689720c3ba2631b8fa4a0162.js.map