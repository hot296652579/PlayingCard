    ...
    execute: function () {
      ...
      _export("default", GameDB = class GameDB {
        ...
        onCheckInPlayArea(poker) {
          ...
          // })
          // return false
          this._playArea.filter(gp => (gp.pokers.filter(p.count == poker.count).length > 0).length > 0);
        } //检测是否在顶部
        ...
        onCheckIndexTop(poker) {
          for (var gp of this._playArea) {
            ...
            if (topPoker.count == poker.count) return true;
          }
...
//# sourceMappingURL=ec48b24aa4ee0b0bdc5c5556204d055096c79e91.js.map