    ...
    execute: function () {
      ...
      _export("default", GameDB = class GameDB {
        ...
        gamePlay() {
          ...
          var temp = this._pokers; // this._closeGroup._pokers = this.pokers
        ...
        onCheckInCloseArea(poker) {
          ...
          console.log('this.closeGroup.pokers', this.closeGroup.pokers);
        ...
        onCheckIndexByCloseTop(poker) {
          ...
          for (var _poker of this._closeGroup.pokers) {
            var topPoker = this._closeGroup.pokers[this._closeGroup.pokers.length - 1];
        ...
        onCheckIndexByOpenTop(poker) {
          ...
          for (var _poker2 of this.openGroup.pokers) {
            var topPoker = this.openGroup.pokers[this.openGroup.pokers.length - 1];
            if (topPoker.count == _poker2.count && topPoker.suit == _poker2.suit) return true;
          }
...
//# sourceMappingURL=096bd108e3ce2ddf58172af26f4c7720de2f5f34.js.map