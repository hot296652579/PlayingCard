      ...
      _export("UIGameView", UIGameView = (_dec = ccclass('UIGameView'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([Node]), _dec6 = property(Node), _dec7 = property(Node), _dec8 = (_crd && clickLock === void 0 ? (_reportPossibleCrUseOfclickLock({
        ...
        onLoad() {
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_PLAYAREA_TO_OTHERPLAY_UPDATE_VIEW, this.playPokerToOtherPlay, this);
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            error: Error()
          }), EventMgr) : EventMgr).getInstance().on((_crd && EventGame_Enum === void 0 ? (_reportPossibleCrUseOfEventGame_Enum({
            error: Error()
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_RECEIVE_TO_PLAY_VIEW, this.receiveToPlay, this);
        }
          ...
          return _asyncToGenerator(function* () {
            ...
            if (i == 0) {
              tween(node).delay(delay).to(0.3, {
                position: new Vec3(nodeEndPos, cardIndex * -75, 0)
              }).to(0.3, {
        ...
        clickCardHandler(poker) {
          ...
          if ((_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
            ...
            if ((_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
              ...
              if (uiPoker.isOpen()) {
                (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
                  ...
                  error: Error()
                }), EventGame_Enum) : EventGame_Enum).EVENT_PLAYAREA_TO_PLAY_UPDATE_DB, uiPoker.poker);
              }
            }
            ...
            error: Error()
          }), GameDB) : GameDB).getInstance().onCheckInReceiveArea(poker)) {
            // console.log('点击的区域是receiveArea')
            if ((_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
              error: Error()
            }), GameDB) : GameDB).getInstance().onCheckIndexReceiveTop(poker)) {
              (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
                error: Error()
              }), EventMgr) : EventMgr).getInstance().emit((_crd && EventGame_Enum === void 0 ? (_reportPossibleCrUseOfEventGame_Enum({
                error: Error()
              }), EventGame_Enum) : EventGame_Enum).EVENT_RECEIVE_TO_PLAY_DB, uiPoker.poker);
            }
          }
        }
        ...
        moveUIPokerToPlayArea(poker) {
          ...
          var nodeEndPos = groupIndex * PADDING_PLAY;
          tween(node).to(0.5, {
            position: new Vec3(nodeEndPos, -75 * pokerIndex, 0)
          }).start();
        }
        ...
        playPokerToOtherPlay(pokers, openPoker) {
          for (var index = pokers.length - 1; index >= 0; index--) {
            var poker = pokers[index];
            this.moveUIPokerToPlayArea(poker);
          }

          if (openPoker) {
            openPoker.dir = (_crd && ECardDir === void 0 ? (_reportPossibleCrUseOfECardDir({
              error: Error()
            }), ECardDir) : ECardDir).OPEN;
...
//# sourceMappingURL=09ddfd227ce8cafa5d7636086e2003c4812bcd73.js.map