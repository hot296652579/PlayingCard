      ...
      _export("default", GameDB = class GameDB {
        ...
        initEvent() {
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_RECEIVE_TO_PLAY_DB, this.onReceiveToPlay, this);
        }
        ...
        onPlayToPlay(poker) {
          ...
          var indexInGroup = poker.indexInGroup();
          ...
          for (var index = 0; index < PLAY_AREA_COUNT; index++) {
            ...
            if (group.isNextPoker(poker)) {
              ...
              var openPoker = null;
              var _pokers = this._playArea[indexInGroup]._pokers;
              ...
              (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
                ...
                error: Error()
              }), EventGame_Enum) : EventGame_Enum).EVENT_PLAYAREA_TO_OTHERPLAY_UPDATE_VIEW, pokers, openPoker);
              break;
            }
          }
        }
          ...
          for (var index = 0; index < PLAY_AREA_COUNT; index++) {
            ...
            if (group.isNextPoker(poker)) {
              ...
              (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
                ...
                error: Error()
              }), EventGame_Enum) : EventGame_Enum).EVENT_RECEIVE_TO_PLAY_VIEW, poker);
              break;
            }
          }
        } //检测这张牌是否在play area
        ...
        onCheckInReceiveArea(poker) {
          return this._receiveArea.filter(pg => pg.pokers.filter(p => p.count == poker.count && p.suit == poker.suit).length > 0).length > 0;
        } //检测是否在receive顶部


        onCheckIndexReceiveTop(poker) {
          for (var gp of this._receiveArea) {
            var pokers = gp.pokers;
            var topPoker = pokers[pokers.length - 1];
            if (!topPoker) continue;
            if (topPoker.count == poker.count && topPoker.suit == poker.suit) return true;
...
//# sourceMappingURL=3679db0f157afe386505cf1289f2e512dacc888a.js.map