System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("moveWorld2Space", moveWorld2Space = function moveWorld2Space(node, targetNode, cleanUp) {
        if (cleanUp === void 0) {
          cleanUp = false;
        }

        var wolrdPos = node.getComponent(UITransform).convertToWorldSpaceAR(new Vec3(0, 0, 0)); // console.log('wolrdPos', wolrdPos)

        var nodePos = targetNode.getComponent(UITransform).convertToNodeSpaceAR(wolrdPos);
...
//# sourceMappingURL=aa5637c1bc282798ba0bae3662dd64e7133de7ba.js.map