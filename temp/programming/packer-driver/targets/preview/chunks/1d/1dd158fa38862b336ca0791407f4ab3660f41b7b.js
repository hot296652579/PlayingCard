      ...
      _export("default", GameDB = class GameDB {
        ...
        initEvent() {
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_OPEN_TO_UPDATE_DB, this.onOpenToReceive, this);
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            error: Error()
          }), EventMgr) : EventMgr).getInstance().on((_crd && EventGame_Enum === void 0 ? (_reportPossibleCrUseOfEventGame_Enum({
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_OPEN_TO_UPDATE_DB, this.onOpenToPlay, this);
        }
        ...
        onOpenToPlay(poker) {
          ...
          for (var index = 0; index < RECEIVE_AREA_COUNT; index++) {
            var group = this._openGroup[index];
...
//# sourceMappingURL=1dd158fa38862b336ca0791407f4ab3660f41b7b.js.map