System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, UIGameView;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIGameView", UIGameView = (_dec = ccclass('UIGameView'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property([Node]), _dec(_class = (_class2 = class UIGameView extends Component {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=a88ec475c547845857ef1d52a8a1ec6a685caaad.js.map