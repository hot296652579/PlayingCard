    ...
    execute: function () {
      ...
      _export("default", GameEngine = class GameEngine {
        ...
        init(m_GameView) {
          ...
          this.initEvent(); // GameDB.getInstance().initEvent()
        ...
        initEvent() {
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_RESTART_GAME, this.restartHandler);
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            error: Error()
          }), EventMgr) : EventMgr).getInstance().on((_crd && EventGame_Enum === void 0 ? (_reportPossibleCrUseOfEventGame_Enum({
            error: Error()
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_GAME_INIT_GROUP, this.gameView.initPlayGroup, this.gameView);
        }

        restartHandler() {
          (_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
            error: Error()
          }), GameDB) : GameDB).getInstance().resetGame();
          (_crd && GameDB === void 0 ? (_reportPossibleCrUseOfGameDB({
            error: Error()
          }), GameDB) : GameDB).getInstance().createCardsDB();
        }
        ...
        exitHandler() {
          ...
          (_crd && EventMgr === void 0 ? (_reportPossibleCrUseOfEventMgr({
            ...
            error: Error()
          }), EventGame_Enum) : EventGame_Enum).EVENT_GAME_INIT_GROUP, this.gameView.initPlayGroup);
        }
...
//# sourceMappingURL=a8032cfce5895732d0e56872cd8ca97dad8efc02.js.map